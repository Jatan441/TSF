 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active ">  <a class="nav-link" href="user_detail.jsp">Account</a></li>
...
<div class="container">
  ...
  <%
  String qr= "select * from useraccounts,branch where id = '"+id+"' AND userAccounts.branch = branch.branchId";
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Currrent Balance</th>
      <td><%=balance %></td>
    </tr>
    <tr>
